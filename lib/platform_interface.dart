...
class CreationParams {
  ...
  @override
  String toString() {
    return '$runtimeType(initialUrl: $initialUrl, userInteractive: $userInteractive, settings: $webSettings, javascriptChannelNames: $javascriptChannelNames, UserAgent: $userAgent)';
  }
}
