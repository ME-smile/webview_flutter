...
class MethodChannelWebViewPlatform implements WebViewPlatformController {
  ...
  Future<bool> _onMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case 'onConsoleMessage':
        _platformCallbacksHandler.onConsoleMessage(call.arguments['message']);
        return null;
    }
  ...
  static Map<String, dynamic> creationParamsToMap(
    ...
    return <String, dynamic>{
      ...
      'initialContent': creationParams.initialContent,
      'initialHost': creationParams.initialHost,
      'userInteractive': creationParams.userInteractive,
